function view(){
    ...
    if(data=="View More"){
        document.getElementById("content").setAttribute("style","margin-top:50px;display:flex; ");
    document.getElementById("button").innerHTML="View Less";
        ...
        document.getElementById("content").setAttribute("style","margin-top:50px;display:none");
    }
}